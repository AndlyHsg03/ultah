// Inisialisasi bintang
        ...
        const quizData = [
            {
                ...
                options: ["Kak Anas", "Gatau"],
                correct: 0,
                responses: {
                    correct: "Benar! Hari ini adalah hari istimewa Kak Anass! 🎉",
                    wrong: "Hehe, salah dong! Yang ultah hari ini adalah Kak Anass 😄"
                }
            },
            {
                question: "Apa yang paling cocok untuk Kak Anass?",
                options: ["Kebahagiaan", "Kesedihan", "Kebosanan"],
                correct: 0,
                responses: {
                    correct: "Tepat sekali! Kak Anas pantas mendapatkan kebahagiaan! ✨",
                    wrong: "Eits, salah! Kak Anas harus selalu bahagia dong! 😊"
                }
            },
            {
                question: "Apa harapan terbaik untuk Kak Anass?",
                options: ["Kesehatan & umur panjang", "Sakit-sakitan", "Biasa aja"],
                correct: 0,
                responses: {
                    correct: "Aamiin! Semoga Kak Anas selalu sehat dan panjang umur! 🤲",
                    wrong: "Waduh, masa gitu sih! Kita doakan yang terbaik dong! 🙏"
                }
            },
            {
                question: "Pertanyaan terakhir, Maafin Adly ga?",
                options: ["Pasti Maafin!", "Hmmm mungkin", "Gak"],
                correct: 0,
                responses: {
                    correct: "Mantap!",
                    wrong: "Yaah kok gitu, tapi kan ini kubuat dengan effort! 😅"
                }
            },
            {
                ...
                responses: {
                    ...
                    wrong: "Gak masalah, pasti bakalan keren! 🎊"
                }
            }
        ];
        ...
        function showDisclaimer() {
            ...
            card.innerHTML = `
                <div style="animation: responseShow 0.8s ease-out;">
                    <h2 style="font-size: 2rem; margin-bottom: 1.5rem; color: #fff;">💝 Pesan Khusus 💝</h2>
                    <p style="font-size: 1.2rem; color: #fff; margin-bottom: 2rem;">"Walaupun ini hampir sepenuhnya dibantu AI, tapi ingat yang prompt ini juga butuh effort - Adly"</p>
                    <button id="start-btn" class="option-btn">Mulai Quiz! 🎯</button>
                </div>
            `;
        ...
        // Auto firework tiap 5 detik untuk background
        setInterval(() => {
